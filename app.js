let main = document.querySelector(".custom-cursor")
...
let fashion = document.querySelector("#elem1")
let productivity = document.querySelector("#elem2")
let gamer = document.querySelector("#elem3")
let audio = document.querySelector("#elem4")
let listeners = document.querySelector("#elem5")
...
document.addEventListener('DOMContentLoaded', function() {
    fashion.addEventListener('mouseenter', function() {
        const newSrc = 'https://www.gonoise.com/cdn/shop/files/Frame_4_80095f1f-f75b-4f87-b539-b75750c391d5.webp?v=1718952933'; // Specify the new image source
        img.src = newSrc;
    });
    fashion.addEventListener('mouseleave', function() {
        img.src = 'https://www.gonoise.com/cdn/shop/files/Frame28_7ab4461f-6a4c-4293-be34-76d3c3380084.png?v=1714461815';

    });
});

productivity.addEventListener('mouseenter', function() {
    const newSrc = 'https://www.gonoise.com/cdn/shop/files/3_43080ba0-2346-4b3c-8b76-1cd6595d45e0.png?v=1718356643'; // Specify the new image source
    img.src = newSrc;
});
productivity.addEventListener('mouseleave', function() {
    img.src = 'https://www.gonoise.com/cdn/shop/files/Frame28_7ab4461f-6a4c-4293-be34-76d3c3380084.png?v=1714461815';

});
gamer.addEventListener('mouseenter', function() {
    const newSrc = 'https://www.gonoise.com/cdn/shop/files/CompressJPEG.online_500x500-image.png?v=1687934644'; // Specify the new image source
    img.src = newSrc;
});
gamer.addEventListener('mouseleave', function() {
    img.src = 'https://www.gonoise.com/cdn/shop/files/Frame28_7ab4461f-6a4c-4293-be34-76d3c3380084.png?v=1714461815';
});
audio.addEventListener('mouseenter', function() {
    const newSrc = 'https://www.gonoise.com/cdn/shop/files/1.4_ae40c598-2079-42d2-ad46-279f00c7dd66.png?v=1704952456'; // Specify the new image source
    img.src = newSrc;
});
...
listeners.addEventListener('mouseenter', function() {
    
    const newSrc = 'https://www.gonoise.com/cdn/shop/files/1_d0a1e568-72fc-41f2-80ef-035534184564.png?v=1714482777'; // Specify the new image source
    img.src = newSrc
}); 
listeners.addEventListener('mouseleave', function() {
    img.src = 'https://www.gonoise.com/cdn/shop/files/Frame28_7ab4461f-6a4c-4293-be34-76d3c3380084.png?v=1714461815';
...
tll.from(".index-page .center img,.blur,#circle",{
    opacity:0,
    scale:0.8,
    duration:2,
})

tll.from(".index-page .left",{
    x:-500,
    opacity:0,
    duration:2
})
tll.from(".index-page .right",{
    x:250,
    duration:1
})

tll.from("#page2 .p-top .products",{
    x:1300,
    duration:5,
    scrollTrigger:{
        trigger:"#page2",
...
document.querySelectorAll(".first").forEach((elem) => {
    elem.addEventListener("mouseenter",
        function () {
            gsap.to(elem.querySelectorAll(".anim1"), {
                y: -60,
                duration: 0.5,
                stagger: 0.03
            });
...
//earbuds-anim-page = ANIMATION CODE
...
gsap.from(".shopping-page-one h1",{
    opacity:0,
    duration:1,
    scrollTrigger:{
        trigger:".shopping-page-one",
        // markers:true,
        start:"top 500"
    }
})

gsap.from(".shopping-page-one .productCard",{
    opacity:0,
    duration:2,
    scrollTrigger:{
        trigger:".shopping-page-one",
